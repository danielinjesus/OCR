    ...
    def __init__(self):
        ...
        self.parser.add_argument('--exp_name', default="TD500", type=str,
                                 choices=['Synthtext', 'Totaltext', 'Ctw1500','Icdar2015', 'Totaltext_mid', 'Ctw1500_mid','TD500HUST_mid','ArT_mid',
                                          "MLT2017", 'TD500HUST', "MLT2019", "ArT", "ALL","preSynthMLT","preALL", 'CustomDataset'], help='Experiment name')
        ...
        # demo args
        self.parser.add_argument('--img_root', default='', help='custom image directory path')
        self.parser.add_argument('--pos', default=False, type=str2bool, help='Position encoding in model')
